...
uv run python pretrain.py \
    ...
    evaluators="[]" \
    \
    +load_checkpoint="checkpoints/totrm-sudoku-extreme/trm-to-totrm-normscale0.2-maxmerge-diversityfixed-weight10.0-margin0.85/step_132804" \
    \
    epochs=30000 \
    eval_interval=1000 \
    lr=1e-4 \
    ...
    +run_name="trm-to-totrm-normscale0.2-maxmerge-diversityfixed-weight10.0-margin0.85_2"
